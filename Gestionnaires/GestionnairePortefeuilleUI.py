...
class Ui_MainWindowPortefeuille(object):
    def setupUi(self, MainWindowPortefeuille):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.tb_liquidite)
        ...
        self.btn_liquidite.setIcon(icon2)
        self.btn_liquidite.setObjectName("btn_liquidite")
        self.horizontalLayout_2.addWidget(self.btn_liquidite)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/calendar-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_today.setIcon(icon3)
        self.btn_today.setObjectName("btn_today")
        self.horizontalLayout_5.addWidget(self.btn_today)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("img/microsoft-excel-2019-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/search-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/edit-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_modif.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/delete-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_suppr.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("img/statistics-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_vis.setIcon(icon8)
        ...
        self.action_deletePortefeuille.setIcon(icon7)
        ...
        self.action_modifyPortefeuilleName.setIcon(icon6)
